...
def draw_HUD():
    ...
    drawText("1. The Best",(screen_width-157,20+25))
    drawText("2. Men",(screen_width-157,20+25*2))
    drawText("3. NASA",(screen_width-157,20+25*3))
    drawText("4. killer",(screen_width-157,20+25*4))
    drawText("5. Big Team",(screen_width-157,20+25*5))
    drawText("6. jumbo",(screen_width-157,20+25*6))
    drawText("7. plz don't kill me",(screen_width-157,20+25*7))
    drawText("8. not i'm",(screen_width-157,20+25*8))
    drawText("9. doge",(screen_width-157,20+25*9))
    if(blob.mass <= 500):
        drawText("10. NOOB",(screen_width-157,20+25*10))
    else:
        drawText("10. AlienCat",(screen_width-157,20+25*10),(210,0,0))
